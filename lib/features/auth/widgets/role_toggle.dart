...
class RoleToggle extends StatelessWidget {
  const RoleToggle({super.key, required this.selected, required this.onChanged});
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? theme.colorScheme.primary.withOpacity(0.06) : theme.colorScheme.surface,
          borderRadius: tokens.cardRadius,
          border: Border.all(
        ...
        child: Column(
          children: [
            Icon(icon, color: isSelected ? theme.colorScheme.primary : theme.colorScheme.outline),
